  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F3F7EE]">
      ...
      <main className="flex-1 px-5 pt-4">
        <h2 className="mb-3 text-lg font-bold text-gray-900">Verify Delivery</h2>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          ...
          <div className="mt-3 flex items-center gap-3 border-t border-gray-100 pt-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Customer waiting at door</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          <h3 className="mt-4 text-lg font-bold text-gray-900">Enter Delivery Code</h3>
          <p className="mt-1 text-center text-sm text-gray-500">
            Ask the customer for the 4-digit code provided to them.
          </p>
          ...
          <div className="mt-6 flex gap-3">
            {digits.map((d, idx) => (
              <input
                ...
                inputMode="numeric"
                maxLength={1}
                className={`h-14 w-14 rounded-xl border-2 text-center text-xl font-bold outline-none ${
                  error ? 'border-red-400 text-red-500' : 'border-primary text-gray-900'
                }`}
              />
            ))}
          </div>
        ...
        <div className="mt-8 flex gap-2 rounded-2xl bg-[#F3F7EE] p-4">
          ...
          <p className="text-xs text-gray-600">
            Only complete the delivery after the customer provides the correct code.
          </p>
        </div>
