...
export default function Earnings() {
  ...
  const weekEarnings = num(
    metrics,
    'weeklyEarnings',
    'thisWeekEarnings'
  );

  const pendingPayout = num(
    metrics,
    'pendingPayout'
  );

  const lastPayoutAmount = num(
    metrics,
    'lastPayoutAmount'
  );
        ...
        <>
          ...
          <div className="mt-4 rounded-2xl bg-white p-4 shadow-sm">
            ...
            <p className="py-6 text-center text-xs text-gray-400">
              A per-day earnings breakdown isn&apos;t in the
              metrics response yet — once that field exists,
              the trend chart plugs in here.
            </p>
          </div>
